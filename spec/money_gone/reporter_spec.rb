  ...
  it "prints top 3 expenses under each category total with indented sub-list" do
    result = {
      ...
      rows: [
        ...
        { booking_date: Date.new(2026, 1, 11), category: "Spesa", amount_signed: -30.0, description_clean: "Supermercato" },
        { booking_date: Date.new(2026, 1, 12), category: "Spesa", amount_signed: -15.0, description_clean: "Ristorante" },
